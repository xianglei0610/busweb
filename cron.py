...
#     sched.add_cron_job(bus_crawl, hour=22, minute=30, args=['scqcp'], kwargs={"crawl_kwargs":{"city": "成都市"}})
    ...
    sched.add_cron_job(bus_crawl, hour=20, minute=0, args=['changtu'], kwargs={"crawl_kwargs":{"city": "天津,潍坊,泰安"}})
    sched.add_cron_job(bus_crawl, hour=23, minute=0, args=['changtu'], kwargs={"crawl_kwargs":{"city": "日照,滨州,德州,聊城"}})
...
#     sched.add_cron_job(bus_crawl, hour=4, minute=10, args=['lnky'], kwargs={"crawl_kwargs":{"city": "盘锦市,大洼县"}})
    ...
    # 山东365汽车票
    sched.add_cron_job(bus_crawl, hour=12, minute=10, args=['sd365'], kwargs={"crawl_kwargs":{"city": "烟台市,蓬莱市,海阳市,栖霞市,招远市,莱阳市,龙口市,济南市,淄博市,济宁市,东营市,聊城市,德州市,潍坊市,天津市,三门峡,莱芜市,枣庄市,榆林,寿光,泰安,新泰市,肥城市,莱州市,滨州市,枣庄市,临沂市"}})
