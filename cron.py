...
def main():
    ...
    sched.add_cron_job(bus_crawl, hour=1, minute=30, args=['tongcheng'], kwargs={"crawl_kwargs":{"city": "昆山,太仓"}})
    sched.add_cron_job(bus_crawl, hour=1, minute=0, args=['tongcheng'], kwargs={"crawl_kwargs":{"city": "常熟,吴江"}})
