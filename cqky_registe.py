...
form_url = "http://www.96096kp.com/Register.aspx"
headers = {
...
def registe(nickname, name, idcard, phone):
    ...
    params["ctl00$FartherMain$txt_IDCode"] = idcard
    params["ctl00$FartherMain$txt_Mobile"] = phone

    code_url = "http://www.96096kp.com/ValidateCode.aspx?"
    ...
    headers["Origin"] = "http://www.96096kp.com"
    headers["Referer"] = "http://www.96096kp.com/Register.aspx"

    r = requests.post("http://www.96096kp.com/Register.aspx", headers=headers, data=urllib.urlencode(params), cookies=cookies)
